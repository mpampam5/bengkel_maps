      ...
      <div class="panel panel-default">
        <div class="panel-body">
          <table class="table table-bordered">
            ...
            <div class="form-group">
              <input type="hidden" name="id_service2" id="id_service2" value="<?=$id_service?>">
              <input type="hidden" name="check" id="chkd">
              <input type="hidden" name="id_trans_kendaraan" id="id_trans_kendaraan" value="<?=$id_trans_kendaraan?>">
