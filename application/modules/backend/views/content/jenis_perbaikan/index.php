        ...
        <div class="row" style="border-bottom:1px solid #d4d2d2;margin-bottom:30px;padding-bottom:10px">
          <div class="col-12">
            ...
            <div class="pull-right">
              <a href='<?=site_url(config_item("cpanel")."jenis_perbaikan/tambah")?>' id='tambah' class='btn btn-success btn-xs pull-right'><i class="fa fa-plus"></i> Tambah</a>
            </div>
          </div>
        </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": '<?=base_url(config_item("cpanel")."jenis_perbaikan/json")?>', "type": "POST"},
                    columns: [
                        {
                            "data": "id_jenis_perbaikan",
                            "orderable": false
           ...
           $(document).on('click', '#tambah', function(e){
               ...
               $('#ModalHeader').html('Tambah Jenis Perbaikan');
           ...
           //   MODAL EDIT
             $(document).on('click', '#edit', function(e){
                 ...
                 $('.modal-dialog').removeClass('modal-sm');
                 $('.modal-dialog').addClass('modal-md');
                 $('#ModalHeader').html('Edit Jenis Perbaikan');
                 $('#ModalContent').load($(this).attr('href'));
                 $('#ModalGue').modal('show');
               });
           //
