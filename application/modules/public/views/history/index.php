...
<section class="m-t-0 p-t-0 p-b-100 m-b-100">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 mx-auto p-b-100 m-b-100">
          <div class="forum-post">
            <div class="forum-body" >
              ...
              <table class="table table-bordered no-footer" cellspacing="0" id="mytable" style="width:100%;">
                <thead>
                  <th>#</th>
                  <th></th>
                  <th></th>
  ...
  $(document).ready(function() {
      var t = $("#mytable").DataTable({
          ...
          bInfo: false,
          lengthChange: false,
          ajax: {"url": '<?=base_url("public/history/json")?>', "type": "POST"},
          columns: [
              {
                  "data": "id",
                  "orderable": false,
              ...
              },
              {
                ...
                {
                  return '<a href="<?=base_url()?>history/detail/'+row.token+'">'+data+'</a>';
                }
              },
              {
                "data":"token",
                render:function(data,type,row,meta)
                {
                  return '<a href="<?=base_url()?>history/detail/'+data+'">'+data+'</a>';
                }
              },
