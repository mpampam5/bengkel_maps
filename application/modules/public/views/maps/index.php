...
<a id="set-lokasi" class="btn btn-block btn-lg btn-flat btn-info text-white" onclick="getUrl()"> Set lokasi saat ini</a>
...
<script type="text/javascript">
  function getUrl()
  {
    window.location.href = "<?=base_url()?>maps/<?=date('dmyhis')?>/"+$("#kordinat").val();
  }
</script>
